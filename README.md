...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-fatw6ia.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-fatw6ia.containers.anotherwebservice.com/
...
```
git clone git@github.com:exhxx-tg/container-fatw6ia.git
cd container-fatw6ia
```
...
```
docker attach container-fatw6ia
```
